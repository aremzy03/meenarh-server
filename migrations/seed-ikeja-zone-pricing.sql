-- Seed Ikeja Zone pricing (pickup region) from company price list CSV
-- Source: `meenarh-pricelist/Ikeja Price List.csv`
--
-- Prerequisites:
...
SELECT 'Ikeja Zone', 'ikeja-zone', 0, TRUE
FROM DUAL
WHERE NOT EXISTS (SELECT 1 FROM pickup_regions WHERE name = 'Ikeja Zone');

-- 2) Delivery regions (names as in the CSV, normalized for whitespace/casing consistency)
...
-- 3) Region rates (flat price + ETA)
-- ETA values are taken directly from the CSV (24 hours, 24/48 hours, 48/72 hours).
...
WHERE p.name = 'Ikeja Zone' AND d.name = 'Lekki Phase 1 Axis'
...
SELECT p.id, d.id, 4000.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'VI Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
INSERT INTO region_rates (pickup_region_id, delivery_region_id, price_ngn, eta_min_hours, eta_max_hours, eta_label, is_active)
SELECT p.id, d.id, 4500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ajah Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 4500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Awoyaya Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Surulere Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 3500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Yaba Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
INSERT INTO region_rates (pickup_region_id, delivery_region_id, price_ngn, eta_min_hours, eta_max_hours, eta_label, is_active)
SELECT p.id, d.id, 2500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ikeja Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
INSERT INTO region_rates (pickup_region_id, delivery_region_id, price_ngn, eta_min_hours, eta_max_hours, eta_label, is_active)
SELECT p.id, d.id, 3000.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ojota Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 4000.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Mushin Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 3500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Agege Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 4000.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Lagos Island Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Igando Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 4500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Amuwo Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 3500.00, 24, 24, '24 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Gbagada Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ojodu Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ojo Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Festac Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ikorodu Garage'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Igbogbo Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Ogolonto Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Owode'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Gberigbe Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 7000.00, 48, 72, '48/72 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Itamaga Axis'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
SELECT p.id, d.id, 7500.00, 48, 72, '48/72 hours', TRUE
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Sango Otta'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
FROM pickup_regions p JOIN delivery_regions d
WHERE p.name = 'Ikeja Zone' AND d.name = 'Badagry'
ON DUPLICATE KEY UPDATE
  price_ngn = VALUES(price_ngn),
  eta_min_hours = VALUES(eta_min_hours),
  eta_max_hours = VALUES(eta_max_hours),
...
-- Note: values are trimmed from the CSV; empty areas are skipped (by omission).
...
-- Sango Otta areas (as provided in CSV)
INSERT IGNORE INTO delivery_region_areas (delivery_region_id, name, is_active)
SELECT d.id, 'Badagry town', TRUE FROM delivery_regions d WHERE d.name = 'Sango Otta';
